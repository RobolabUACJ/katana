...
float Ultrasonico(int Identificador)
{
    ...
    float RAWDistancia;
    float Distancia;
    //20ms Delay: Sensor stabillization
    Wait_ms(20);
	...
	mIC1ClearIntFlag();
        ...
        _TRISE8=0;
        _RE8=1;
        //1ms delay (Ideal 20 microseconds)
        Wait_10us(1);
        _RE8=0;
	...
	while( mIC1CaptureReady() )
	{
        ...
        sensores.sonar1.vsonar1= Distancia;
        INPacket[17]= sensores.sonar1.dsonar1[0];
        INPacket[18]= sensores.sonar1.dsonar1[1];
        INPacket[19]= sensores.sonar1.dsonar1[2];
        INPacket[20]= sensores.sonar1.dsonar1[3];
...
float Compass(void)
{
    ...
    sensores.compass.vcompass= ANGULO;
    INPacket[17]= sensores.compass.dcompass[0];
    INPacket[18]= sensores.compass.dcompass[1];
    INPacket[19]= sensores.compass.dcompass[2];
    INPacket[20]= sensores.compass.dcompass[3];
